...
# 17 "christmas_tree.c"
    ...
    printf("\nChristmas tree:\n\n");
    {size_t fill_i; for(fill_i = 0; fill_i < (n + 1); fill_i++){ printf(" "); } };
    printf("_\n");
    {size_t fill_i; for(fill_i = 0; fill_i < (n); fill_i++){ printf(" "); } };
    printf("/ \\\n");
    for(i = 0; i < n; i++)
    {
        {size_t fill_i; for(fill_i = 0; fill_i < (n - i - 1); fill_i++){ printf(" "); } };
        printf("/ ");
        {size_t fill_i; for(fill_i = 0; fill_i < (i + 1); fill_i++){ printf("* "); } };
        printf("\\");
        printf("\n");
    }

    return 
# 35 "christmas_tree.c" 3
          0
# 35 "christmas_tree.c"
                      ;
}
